...
export async function getSvgList(params) {
    return request(`/nlp/ret/search/markDatas`, {
        body: { ...params },
        method: "POST"
    })
}
...
export async function updateLabel(params, taskId) {
    return request(`/nlp/ret/update/labelCategories?taskId=${taskId}`, {
        body: params,
        isForm: true,
        method: "POST"
    })
...
export async function saveSvgInfo(params, taskId, paths) {
    ...
    return request(`/nlp/ret/save/markDatas?taskId=${taskId}&paths=${result}`, {
        body: params,
        isForm: true,
        method: "POST"
    })
