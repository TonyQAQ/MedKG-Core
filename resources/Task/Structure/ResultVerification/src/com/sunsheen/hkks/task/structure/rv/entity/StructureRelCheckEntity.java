package com.sunsheen.hkks.task.structure.rv.entity;
 ...
 * @Description: RDF关系实体,正式的关系信息
 * @author: FengTao
 * @date 2020年7月30日 下午6:09:44
 */
@Entity
@Table(name = "HANDLE_STRUCTURED_RESULT")
public class StructureRelCheckEntity {
	@Id
	...
	public String toString() {
		return "StructureRelCheckEntity [resultId=" + resultId + ", taskId="
				+ taskId + ", attrStart=" + attrStart + ", attrEnd=" + attrEnd
				+ ", attrUnique=" + attrUnique + ", rel=" + rel + ", isUsed="
				+ isUsed + ", userId=" + userId + ", userName=" + userName
